    ...
    try{
        if($conex->consultar($sql) != null){
          foreach ($conex->consultar($sql) as $row) {
            ...
            echo '<td><p align="center">'.$row['nombreSucursal'].'</p></td>';
            echo '<td><p align="center">'.$row['nombreDB'].'</p></td>';
            echo '<td><p align="center">'.$row['ipSucursal'].'</p></td>';
            echo '<td align="center"><a align="center" href="../vistas/modificarSucursalesView.php?nombreSucursal='.$row['nombreSucursal'].'"><img src="../../images/formularios/if_compose_1055085.png" /></a> </td>';
            //echo '<td align="center"><a align="center" href="../procesos/eliminarSucursales.php?nombreSucursal='.$row['nombreSucursal'].'"><img src="../../images/formularios/eliminar.png"/></a> </td>';

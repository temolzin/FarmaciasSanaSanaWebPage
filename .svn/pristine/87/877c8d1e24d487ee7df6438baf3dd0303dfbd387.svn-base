...
<body>
    <div id="wrapper">
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                ...
                <?php 
                  menu('reporteVentasExistenciasSugerido');
                 ?>
                </ul>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                     <h2 align="center">
                        Reporte Ventas Existencias con Sugerido.
                     </h2>   
            ...
            <input class="form-control"  name="MAX_FILE_SIZE" type="hidden" value="20000" /> 
                    ...
                    <br><br><br><br>
                    <div id="diasSugerido" name="diasSugerido">
                     <div class="col-md-3"></div>
                       <div class="col-md-2">
                            <font size="4" color="black">Días Proveedor</font>
                        </div>
                      <div class="col-md-3">
                         <input type="text" onclick ="return soloNumeros(event);" onchange="return soloNumeros(event);" onkeypress="return soloNumeros(event);" class="form-control" name="diasProveedor"  id="diasProveedor" />
                      </div>
                    </div>
                    <br><br><br><br>
                    <div class="col-md-3"></div> 
    ...
    $("#formulario").validate({
        ...
        messages: {
            ...
            diasProveedor: {
              required: "<font color='red'> Ingresa los días del Proveedor</p>"
            }
        },
        ...
        var diasProveedor =  document.getElementById('diasProveedor');
        ...
        form_data.append('diasProveedor', diasProveedor.value);
          $('#bodyTabla').html('<div align="center"><img src="../../images/formularios/cargando.gif"/><br><p class="text-info lead">Cargando...</p></div>');
            $.ajax({
                ...
                <div class="col-md-3"></div>
                <div class="col-md-3">
                    <a href="../procesos/exportarArchivo/exportarReporteVentasExistenciasSugerido.php?tipo=excel"><button class="btn btn-success btn-lg"  id="btnExcel" value="excel" style="display:none" name="btnExcel"><img width="18px" height="18px" src="../../images/formularios/excel.png"> Exportar a Excel</button></a>
                </div>
                <div class="col-md-3">
                    <a href="../procesos/exportarArchivo/exportarReporteVentasExistenciasSugerido.php?tipo=word"><button class="btn btn-info btn-lg" id="btnWord" value="word" style="display:none" name="btnWord"><img width="18px" height="18px" src="../../images/formularios/word.png"> Exportar a Word</button></a>
                </div>
                    <br><br><br>
                 </div>
                 </div>

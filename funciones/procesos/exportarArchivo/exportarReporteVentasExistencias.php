...
//Se hace el procedimiento para consultar los SKU en todas las sucursales.
    ...
    $codigoHtml .= '
      ...
      <body>
        <table border="1">
          <tr>
            <td colspan="44" align="center" bgcolor="#82BDF8"> 
          ...
          <tr>
            ...
            <td colspan="2" align="center" bgcolor="#F5DA81">512</td>
            <td colspan="2" align="center" bgcolor="#81F79F">517</td>
            <td colspan="2" align="center" bgcolor="#81BEF7">E-21</td>
            <td colspan="2" align="center" bgcolor="#B18904">TULTITLÁN</td>
            <td colspan="2" align="center" bgcolor="#0080FF">CENTRO</td>
            <td colspan="2" align="center" bgcolor="#2ECCFA">NUEVO LAREDO</td>
            <td colspan="2" align="center" bgcolor="#CEF6F5">GH-45</td>
            <td colspan="2" align="center" bgcolor="#F2F5A9">CASAS ALEMÁN</td>
            <td colspan="2" align="center" bgcolor="#81DAF5">TEZONTEPEC</td>
            <td colspan="2" align="center" bgcolor="#BDBDBD">CIUDAD AZTECA</td>
            <td colspan="2" align="center" bgcolor="#F5A9BC">CIUDAD NEZA</td>
            <td colspan="2" align="center" bgcolor="#CECEF6">SAN PABLO</td>
            <td colspan="2" align="center" bgcolor="#BCF5A9">LA RIOJA</td>
            <td colspan="2" align="center" bgcolor="#81F7F3">TECÁMAC CENTRO</td>
            <td colspan="2" align="center" bgcolor="#F7BE81">VÍA MORELOS</td>
            <td colspan="2" align="center" bgcolor="#E2A9F3">CIUDAD CUAUHTEMOC</td>
            <td colspan="2" align="center" bgcolor="#F3E2A9">TECÁMAC LP</td>
            <td colspan="2" align="center" bgcolor="#CEF6CE">IZCALLI</td>
            <td colspan="2" align="center" bgcolor="#CEF6CE">SAN CRISTÓBAL</td>
            <td colspan="2" align="center" bgcolor="#CEF6CE">TECÁMAC PRESIDENCIA</td>
            <td colspan="2" align="center" bgcolor="#CEF6CE">JARDINES MORELOS</td>
            <td colspan="2" align="center" bgcolor="#CEF6CE">VIA REAL</td>
          </tr>
          <tr>
            <td>Existencias</td>
            <td>Ventas</td>
      ...
      <body>
        <table border="1">
          <tr>
            <td colspan="4" align="center" bgcolor="#82BDF8"> 
              <strong>Reporte Ventas Existencias del '.$fechaInicio.' al ' .$fechaFin. ' </strong>
            </td>
          </tr>
          <tr>
            ...
            //Se obtiene el nombre de la sucursal.
              ...
              foreach ($conex->consultar($sqlSucursales) as $sucursal) {
                $codigoHtml .= '<td colspan="2" align="center" bgcolor="#F5DA81">'.$sucursal['nombreSucursal'].'</td>';
              } 
          $codigoHtml .= '
          </tr>
          <tr>

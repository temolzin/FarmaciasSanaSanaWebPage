...
<head>
    ...
    function obtenerFolioSeleccionado()
    {
        var resultado=""; 
        var porNombre=document.getElementsByName("detalleVenta");
    ...
    <title>Consulta Ventas por Sector</title>
    <!-- BOOTSTRAP STYLES-->
            ...
            <div id="page-inner">
                <div class="row">
                 ...
                 <form method="POST" id="formulario" name="formulario">
                    ...
                    <div class="col-md-3"></div> 
                    <div class="col-md-2">
                      <font size="4" color="black">Sector</font>
                    </div>
                    <div class="col-md-3">
                    <select id="comboSector" name="comboSector" class="form-control">
                      <?php 
                        $consulta = $conex->consultar("select * from sectores");
                        foreach ($consulta as $row) {
                          echo '<option value = "'.$row['valorSector'].'" > '.$row['nombreSector'].' </option>';
                        }
                        $conex = null;
                      ?> 
                      </select>
    ...
    $("#formulario").validate({
        ...
        submitHandler: function(){
          $('#bodyTabla').html('<div align="center"><img src="../../images/formularios/cargando.gif"/><br><p class="text-info lead">Cargando...</p></div>');
            $.ajax({
                  type: "POST",
                  url: '../procesos/consultaVentasSector.php',
                  ...
                  success: function(data) {
                    ...
                    <div id="tablaDetalleVenta" name="tablaDetalleVenta">
                      <!-- Se genera la tabla con el detalle de la venta -->
                    </div>
                    <br><br><br>
                    <!-- Inicio del Datable -->    
                ...
                <div class="col-md-3"></div>
                <div class="col-md-3">
                    <a href="../procesos/exportarArchivo/exportarVentasSector.php?tipo=excel"><button class="btn btn-success btn-lg"  id="btnExcel" value="excel" style="display:none" name="btnExcel"><img width="18px" height="18px" src="../../images/formularios/excel.png"> Exportar a Excel</button></a>
                </div>
                <div class="col-md-3">
                    <a href="../procesos/exportarArchivo/exportarVentasSector.php?tipo=word"><button class="btn btn-info btn-lg" id="btnWord" value="word" style="display:none" name="btnWord"><img width="18px" height="18px" src="../../images/formularios/word.png"> Exportar a Word</button></a>
                </div>
                <br><br><br>
                 </div>
                 </div>
